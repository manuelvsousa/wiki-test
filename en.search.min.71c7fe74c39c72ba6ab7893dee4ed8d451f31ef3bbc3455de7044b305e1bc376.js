...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/wiki-test/flexsearch.min.js');loadScript('/wiki-test/en.search-data.min.aff8fd66b0b89899f3be875e7d076da963949fe7199a2ade22a7e23fda806fb9.js',function(){input.required=false;search();});}
